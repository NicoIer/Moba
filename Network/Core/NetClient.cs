...
namespace Nico
{
    public struct ServerMsg<T>
    {
        ...
        public static implicit operator T (ServerMsg<T> msg)
        {
            return msg.msg;
        }
    }
    ...
    public class NetClient
    {
        ...
        public void RegisterHandler<T>(Action<ServerMsg<T>> handler) where T : IMessage<T>, new()
        {
            int id = TypeId<T>.ID;
        ...
        public void UnRegisterHandler<T>(Action<ServerMsg<T>> handler) where T : IMessage<T>, new()
        {
            int id = TypeId<T>.ID;
            if (!_handlers.ContainsKey(id))
            {
